import { trilhaService, TrilhaSummary } from '@/src/screens/services/trilhaService';
...
export default function TrilhasScreen() {
  ...
  const handleDelete = (id: string) => {
    Alert.alert('Confirmar', 'Deseja realmente remover esta trilha?', [
      { text: 'Cancelar', style: 'cancel' },
      {
        ...
        onPress: async () => {
          try {
            ...
            Alert.alert('Erro', 'Não foi possível remover a trilha.');
          }
        },
      },
    ]);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Aqui ficam as trilhas que apoiam o aluno a estudar no ritmo certo, alinhadas ao bem-estar
        que o PerifaFlow monitora.
      </Text>
      ...
      <View style={styles.form}>
        ...
        <TextInput
          style={styles.input}
          placeholder="Título da trilha (ex: Fundamentos Java para começar leve)"
        ...
        <TextInput
          ...
          placeholder="Descrição (o que o aluno vai conseguir ao concluir, em linguagem acessível)"
          placeholderTextColor="#888"
          value={descricao}
      ...
      <FlatList
          ...
          <View style={styles.card}>
            ...
            <View style={styles.actions}>
              ...
              <TouchableOpacity onPress={() => handleDelete(item.id)}>
                <Text style={[styles.link, { color: '#FF5555' }]}>Remover</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
        ListEmptyComponent={
          <Text style={{ color: '#FFF', marginTop: 16 }}>
            Nenhuma trilha cadastrada ainda. Comece criando uma trilha base para os alunos.
          </Text>
        }
